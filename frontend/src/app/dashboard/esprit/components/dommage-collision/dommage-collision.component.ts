...
@Component({
  selector: 'app-dommage-collision',
  templateUrl: './dommage-collision.component.html',
  styleUrl: './dommage-collision.component.scss'
})
export class DommageCollisionComponent {
  ...
  async createPdf() {
    ...
    const dommageCollision = "Dommage et Collision";
    page.drawText(dommageCollision, {
      x: 460, // Adjust this value to position the text correctly
      y: 155, // Adjust this value to position the text correctly
      size: 47, // Large size for the text
