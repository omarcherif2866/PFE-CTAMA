...
@Component({
  selector: 'app-tout-risque',

  templateUrl: './tout-risque.component.html',
  styleUrl: './tout-risque.component.scss'
})
export class ToutRisqueComponent {
  ...
  async createPdf() {
    ...
    const toutRisque = "Tout risque";
    page.drawText(toutRisque, {
      x: 460, // Adjust this value to position the text correctly
      y: 148, // Adjust this value to position the text correctly
      size: 90, // Large size for the text
